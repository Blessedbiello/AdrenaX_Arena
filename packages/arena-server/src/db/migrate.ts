  ...
  '001_initial': {
    async up(db: Kysely<unknown>) {
      ...
      await db.schema
        ...
        .addColumn('pnl_usd', 'numeric(20,6)', col => col.defaultTo(0))
        .addColumn('roi_percent', 'numeric(10,4)', col => col.defaultTo(0))
        .addColumn('total_volume_usd', 'numeric(20,6)', col => col.defaultTo(0))
        .addColumn('positions_closed', 'integer', col => col.defaultTo(0))
        .addColumn('win_rate', 'numeric(6,4)', col => col.defaultTo(0))
        .addColumn('arena_score', 'numeric(12,4)', col => col.defaultTo(0))
      ...
      await db.schema
        ...
        .addColumn('entry_price', 'numeric(20,10)')
        .addColumn('exit_price', 'numeric(20,10)')
        .addColumn('entry_size', 'numeric(20,6)')
        .addColumn('collateral_usd', 'numeric(20,6)')
        .addColumn('pnl_usd', 'numeric(20,6)')
        .addColumn('fees_usd', 'numeric(20,6)')
      ...
      await db.schema
        ...
        .addColumn('stake_amount', 'numeric(20,6)', col => col.defaultTo(0))
        ...
        .addColumn('challenger_roi', 'numeric(10,4)')
        .addColumn('defender_roi', 'numeric(10,4)')
      ...
      await db.schema
        ...
        .addColumn('mutagen_reward', 'numeric(20,6)', col => col.defaultTo(0))
        .execute();
      ...
      await db.schema
        ...
        .addColumn('user_pubkey', 'varchar(44)', col => col.notNull())
        .addColumn('amount', 'numeric(20,6)', col => col.notNull())
